...
one_filename = '../1244Mpc_f2_8.2S_250_pyt/results/xid_ps_244Mpc_8.2S_250_7.960.dat'
two_filename =	'../1244Mpc_f2_8.2S_250_pyt/results/xid_ps_244Mpc_8.2S_250_7.263.dat'
three_filename = '../1244Mpc_f2_8.2S_250_pyt/results/xid_ps_244Mpc_8.2S_250_6.905.dat'
...
fg.update(hspace=0) 
up = pl.subplot(fg[0,:])
up.loglog(f1[:,0],f1[:,0]**3*f1[:,1]/(2*np.pi**2),'b-',label='$\delta T_{\\rm b}$',lw=0.75)
up.loglog(f1[:,0],f1[:,0]**3*f1[:,3]/(2*np.pi**2),'b:',label='$x_{\\rm HI}$',lw=1.3)
up.loglog(f1[:,0],f1[:,0]**3*f1[:,4]/(2*np.pi**2),'b--',label='$\delta_{\\rm \\rho}$',lw=1)
up.loglog(f1[:,0],f1[:,0]**3*f1[:,5]/(2*np.pi**2),'b-.',label='$\delta_{\\rm \\rho}x_{\\rm HI}$',lw=1)
up.loglog(f1[:,0],-1*f1[:,0]**3*f1[:,5]/(2*np.pi**2),'k-.')
up.loglog(f4[:,2]*.7,f4[:,3],'b-',label='Mao',lw=0.25)
...
mid = pl.subplot(fg[1,:])
mid.loglog(f2[:,0],f2[:,0]**3*f2[:,1]/(2*np.pi**2),'b-',lw=0.75)
mid.loglog(f2[:,0],f2[:,0]**3*f2[:,3]/(2*np.pi**2),'b:',lw=1)
mid.loglog(f2[:,0],f2[:,0]**3*f2[:,4]/(2*np.pi**2),'b--',lw=1)
mid.loglog(f2[:,0],f2[:,0]**3*f2[:,5]/(2*np.pi**2),'b-.',label='$\delta_{\\rm \\rho}x_{\\rm HI}$',lw=1)
mid.loglog(f2[:,0],-1*f2[:,0]**3*f2[:,5]/(2*np.pi**2),'k-.')
mid.loglog(f5[:,2]*.7,f5[:,3],'b-',lw=0.25)
...
low = pl.subplot(fg[2,:])
low.loglog(f3[:,0],f3[:,0]**3*f3[:,1]/(2*np.pi**2),'b-',lw=0.75)
low.loglog(f3[:,0],f3[:,0]**3*f3[:,3]/(2*np.pi**2),'b:',lw=1)
low.loglog(f3[:,0],f3[:,0]**3*f3[:,4]/(2*np.pi**2),'b--',lw=1)
low.loglog(f3[:,0],f3[:,0]**3*f3[:,5]/(2*np.pi**2),'b-.',label='$\delta_{\\rm \\rho}x_{\\rm HI}$',lw=1)
low.loglog(f3[:,0],-1*f3[:,0]**3*f3[:,5]/(2*np.pi**2),'k-.')
low.loglog(f6[:,2]*.7,f6[:,3],'b-',lw=0.25)
...
pl.savefig('./png/xid_ps_244Mpc_f2_8.2S_250.png')
