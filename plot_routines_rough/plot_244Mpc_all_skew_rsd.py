...
pl.savefig('./png/dTskew_244_rsd_sources.png')
...
pl.savefig('./png/dTskew_244_rsd_b5nu4_sources.png')

pl.clf()
pl.plot(f5[:,2],f1[:,4],'r-',lw=1.5,label='L1')
pl.plot(f6[:,2],f2[:,4],'b:',lw=2,label='L2')
pl.plot(f7[:,2],f3[:,4],'g--',lw=2,label='L3')
pl.plot(f8[:,2],f4[:,4],'m-.',lw=2,label='L4')
...
leg = pl.legend(loc='upper right',prop={'size':11})
leg.draw_frame(False)
pl.savefig('./eps/dTskewxi_244_rsd_sources.eps')
pl.savefig('./png/dTskewxi_244_rsd_sources.png')
...
leg = pl.legend(loc='upper right',prop={'size':11})
leg.draw_frame(False)
pl.savefig('./eps/dTskewxi_244_rsd_b5nu4_sources.eps')
pl.savefig('./png/dTskewxi_244_rsd_b5nu4_sources.png')
...
pl.minorticks_on()
pl.savefig('./eps/dTskewkurt_244_rsd_b5nu4_sources.eps')
pl.savefig('./png/dTskewkurt_244_rsd_b5nu4_sources.png')
