...
pl.figure()
pl.plot(np.log10(f1[:,0]+1e-12),np.log10(f1[:,0]**3*f1[:,1]/(2*np.pi**2)+1e-12),'r-',label='244Mpc_f2_0_250',lw=1.5)
pl.plot(np.log10(f4[:,0]+1e-12),np.log10(f4[:,0]**3*f4[:,1]/(2*np.pi**2)+1e-12),'r:',label='244Mpc_f2_0_500',lw=2)
pl.plot(np.log10(f7[:,0]+1e-12),np.log10(f7[:,0]**3*f7[:,1]/(2*np.pi**2)+1e-12),'g-',label='244Mpc_f2_8.2pS_250',lw=2)
pl.plot(np.log10(f10[:,0]+1e-12),np.log10(f10[:,0]**3*f10[:,1]/(2*np.pi**2)+1e-12),'g:',label='244Mpc_f2_8.2pS_500',lw=2)
pl.xlim([-1.5,0.8])
pl.ylim([-1.2,2.0])
pl.minorticks_on()
...
pl.savefig('./eps/ps_res_244Mpc_rsd_x03.eps')
pl.savefig('./png/ps_res_244Mpc_rsd_x03.png')

pl.clf()
pl.plot(np.log10(f2[:,0]+1e-12),np.log10(f2[:,0]**3*f2[:,1]/(2*np.pi**2)+1e-12),'r-',label='244Mpc_f2_0_250',lw=1.5)
pl.plot(np.log10(f5[:,0]+1e-12),np.log10(f5[:,0]**3*f5[:,1]/(2*np.pi**2)+1e-12),'r:',label='244Mpc_f2_0_500',lw=2)
pl.plot(np.log10(f8[:,0]+1e-12),np.log10(f8[:,0]**3*f8[:,1]/(2*np.pi**2)+1e-12),'g-',label='244Mpc_f2_8.2pS_250',lw=2)
pl.plot(np.log10(f11[:,0]+1e-12),np.log10(f11[:,0]**3*f11[:,1]/(2*np.pi**2)+1e-12),'g:',label='244Mpc_f2_8.2pS_500',lw=2)
pl.xlim([-1.5,0.8])
pl.ylim([-0.,1.8])
pl.minorticks_on()
pl.xlabel('$\\rm{log_{10}}($$k$$)\; \\rm{[Mpc^{-1}]}$')
...
pl.savefig('./eps/ps_res_244Mpc_rsd_x05.eps')
pl.savefig('./png/ps_res_244Mpc_rsd_x05.png')

pl.clf()
pl.plot(np.log10(f3[:,0]+1e-12),np.log10(f3[:,0]**3*f3[:,1]/(2*np.pi**2)+1e-12),'r-',label='244Mpc_f2_0_250',lw=1.5)
pl.plot(np.log10(f6[:,0]+1e-12),np.log10(f6[:,0]**3*f6[:,1]/(2*np.pi**2)+1e-12),'r:',label='244Mpc_f2_0_500',lw=2)
pl.plot(np.log10(f9[:,0]+1e-12),np.log10(f9[:,0]**3*f9[:,1]/(2*np.pi**2)+1e-12),'g-',label='244Mpc_f2_8.2pS_250',lw=2)
pl.plot(np.log10(f12[:,0]+1e-12),np.log10(f12[:,0]**3*f12[:,1]/(2*np.pi**2)+1e-12),'g:',label='244Mpc_f2_8.2pS_500',lw=2)
pl.xlim([-1.5,0.8])
pl.ylim([-0.,1.5])
pl.minorticks_on()
pl.xlabel('$\\rm{log_{10}}($$k$$)\; \\rm{[Mpc^{-1}]}$')
...
pl.savefig('./eps/ps_res_244Mpc_rsd_x07.eps')
pl.savefig('./png/ps_res_244Mpc_rsd_x07.png')
...
pl.savefig('./eps/ps_244Mpc_rsd_res.eps')
pl.savefig('./png/ps_244Mpc_rsd_res.png', bbox_inches='tight')
