...
pl.plot(f10[:,0]-f10[:,2],np.log10(f10[:,1]+1e-14),'m-.',label='L4',lw=2)
pl.text(-10,-0.4,'$x_m=0.3$',fontsize=16)
pl.xlim([-18,32])
pl.ylim([-5,0])
...
pl.savefig('./png/dT_PDF_rsd_244Mpc_250_x30.png')
pl.savefig('./eps/dT_PDF_rsd_244Mpc_250_x30.eps')
...
pl.text(-10,-0.4,'$x_m=0.5$',fontsize=16)
pl.xlim([-18,32])
pl.ylim([-5,0])
#pl.title('Mass-weighted')
pl.xlabel('$(\delta T_b-\\bar{\delta T_b}) \\rm{[mK]}$',fontsize=16)
...
pl.savefig('dT_PDF_rsd_244Mpc_250_x50.png')
...
pl.text(-10,-0.4,'$x_m=0.9$',fontsize=16)
pl.xlim([-18,32])
pl.ylim([-5,0])
#pl.title('Mass-weighted')
pl.xlabel('$(\delta T_b-\\bar{\delta T_b}) \\rm{[mK]}$',fontsize=16)
...
pl.savefig('./png/dT_PDF_rsd_244Mpc_250_x90.png')
pl.savefig('./eps/dT_PDF_rsd_244Mpc_250_x90.eps')
